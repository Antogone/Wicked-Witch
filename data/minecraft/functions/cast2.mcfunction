...
execute as @e[tag=wicked,scores={click=1..,magie=10..}] at @s run summon marker ~ ~ ~ {duration:1,Tags:[telp]}
execute as @e[tag=wicked,scores={click=1..,magie=10..}] at @s run fill ~-10 ~-10 ~10 ~10 ~10 ~-10 air replace barrier
...
execute as @e[tag=telp,limit=1,sort=nearest] at @s run function effect2
