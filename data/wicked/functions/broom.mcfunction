...
item replace entity @a[tag=wicked,limit=1,scores={select=1},gamemode=!spectator,predicate=wicked:select_broom_2] armor.head with command_block{HideFlags:3,CustomModelData:14120001,Unbreakable:1,display:{Name:"{\"text\":\"§2Witch's Broom\"}"},Enchantments:[{}]}
