...
# BONUS 
###########################
effect give @a[tag=wicked,limit=1,nbt=!{active_effects:[{id:"minecraft:saturation",amplifier:0b,duration:-1}]}] saturation infinite 0 true
effect give @a[tag=wicked,limit=1,nbt=!{active_effects:[{id:"minecraft:jump_boost",amplifier:1b,duration:-1}]}] jump_boost infinite 1 true
...
# MODE MAGIE ACTIF
###########################
execute as @a[tag=wicked,limit=1,nbt=!{Inventory:[{Slot:-106b,id:"minecraft:totem_of_undying",tag:{ench:[{lvl:211,id:34}]}}]}] run execute if score @a[tag=wicked,limit=1] select matches 1 run function wicked:item_storage/normal

execute as @a[tag=wicked,limit=1,nbt={Inventory:[{Slot:-106b,id:"minecraft:totem_of_undying",tag:{ench:[{lvl:211,id:34}]}}]}] run execute if score @a[tag=wicked,limit=1] select matches 0 run function wicked:item_storage/don

execute as @a[tag=wicked,limit=1,nbt={Inventory:[{Slot:-106b,id:"minecraft:totem_of_undying",tag:{ench:[{lvl:211,id:34}]}}]}] run scoreboard players set @a[tag=wicked,limit=1,nbt={Inventory:[{Slot:-106b,id:"minecraft:totem_of_undying",tag:{ench:[{lvl:211,id:34}]}}]}] select 1
execute as @a[tag=wicked,limit=1,nbt=!{Inventory:[{Slot:-106b,id:"minecraft:totem_of_undying",tag:{ench:[{lvl:211,id:34}]}}]}] run scoreboard players set @a[tag=wicked,limit=1,nbt=!{Inventory:[{Slot:-106b,id:"minecraft:totem_of_undying",tag:{ench:[{lvl:211,id:34}]}}]}] select 0
...
#SCEPTER
execute if score @a[tag=wicked,limit=1,scores={select=1}] magie matches 0.. run item replace entity @a[tag=wicked,limit=1,scores={select=1,magie=0..}] hotbar.0 with carrot_on_a_stick{HideFlags:3,CustomModelData:10140003,Unbreakable:1b,display:{Name:"{\"text\":\"§2Scepter\"}",Lore:["{\"text\":\"§2Magic Cost : 10\"}"]},Enchantments:[{id:"minecraft:sharpness",lvl:8s},{id:"minecraft:smite",lvl:8s},{id:"minecraft:bane_of_arthropods",lvl:8s}],AttributeModifiers:[{AttributeName:"generic.attackSpeed",Name:"generic.attackSpeed",Amount:1,Operation:2,UUIDLeast:80949,UUIDMost:496823},{AttributeName:"generic.attackDamage",Name:"generic.attackDamage",Amount:12,Operation:1,UUIDLeast:690100,UUIDMost:811832}]}



#POOFING
execute if score @a[tag=wicked,limit=1,scores={select=1}] magie matches 10.. run item replace entity @a[tag=l20,tag=wicked,limit=1,scores={select=1,magie=10..}] hotbar.2 with carrot_on_a_stick{HideFlags:3,CustomModelData:10140001,Unbreakable:1,display:{Name:"{\"text\":\"§2Poofing\"}",Lore:["{\"text\":\"§2Magic Cost : 10\"}"]},Enchantments:[{}]}

#IMMOBILIZATION
execute if score @a[tag=wicked,limit=1,scores={select=1}] magie matches 10.. run item replace entity @a[tag=l30,tag=wicked,limit=1,scores={select=1,magie=10..}] hotbar.3 with carrot_on_a_stick{HideFlags:3,CustomModelData:10140001,Unbreakable:1,display:{Name:"{\"text\":\"§2Immobilization\"}",Lore:["{\"text\":\"§2Magic Cost : 10\"}"]},Enchantments:[{}]}

#FIREBALL
execute if score @a[tag=wicked,limit=1,scores={select=1}] magie matches 5.. run item replace entity @a[tag=l10,tag=wicked,limit=1,scores={select=1,magie=5..}] hotbar.1 with snowball{HideFlags:3,CustomModelData:10140002,Unbreakable:1,display:{Name:"{\"text\":\"§2Fireball\"}",Lore:["{\"text\":\"§2Magic Cost : 5\"}"]},Enchantments:[{}]}

#FLYING SPELL
execute if score @a[tag=wicked,limit=1,scores={select=1,typevol=0}] magie matches 0.. run item replace entity @a[tag=l15,tag=wicked,limit=1,scores={select=1,magie=0..,typevol=0}] hotbar.4 with feather{HideFlags:3,CustomModelData:10140015,Unbreakable:1,display:{Name:"{\"text\":\"§2Witch's Broom\"}"},Enchantments:[{}]}


###########################
# POOFING
###########################
execute as @a[tag=wicked,limit=1] at @s if score @a[tag=wicked,limit=1,scores={magie=10..},predicate=!wicked:is_sneaking,nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:"{\"text\":\"§2Poofing\"}"}}}}] click matches 1..100 run function wicked:poofing/cast
execute as @a[tag=wicked,limit=1] at @s if score @a[tag=wicked,limit=1,predicate=wicked:is_sneaking,scores={magie=10..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:"{\"text\":\"§2Poofing\"}"}}}}] click matches 1..100 run function wicked:poofing/cast2
...
# SCEPTER
###########################
execute as @a[tag=wicked,limit=1] at @s if score @a[tag=wicked,limit=1,nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:"{\"text\":\"§2Scepter\"}"}}}}] click matches 1..10 run function wicked:wicked_ray/cast
...
###### PARTICLE 
execute at @a[tag=l40,tag=wicked,limit=1,predicate=wicked:is_sneaking,scores={bro=0,select=1},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{HideFlags:3,CustomModelData:10140003,Unbreakable:1b,display:{Name:"{\"text\":\"§2Scepter\"}"},Enchantments:[{id:"minecraft:sharpness",lvl:8s},{id:"minecraft:smite",lvl:8s},{id:"minecraft:bane_of_arthropods",lvl:8s}],AttributeModifiers:[{AttributeName:"generic.attackSpeed",Name:"generic.attackSpeed",Amount:1,Operation:2,UUIDLeast:80949,UUIDMost:496823},{AttributeName:"generic.attackDamage",Name:"generic.attackDamage",Amount:12,Operation:1,UUIDLeast:690100,UUIDMost:811832}]}}}] run function wicked:cauldron/particle/alchemymod_shield
...
execute if score @a[tag=wicked,limit=1,scores={select=1}] magie matches 0..9 run item replace entity @a[tag=l20,tag=wicked,limit=1,scores={select=1,magie=0..9}] hotbar.2 with red_dye{HideFlags:3,CustomModelData:10140001,Unbreakable:1,display:{Name:"{\"text\":\"§cReloading\"}"},Enchantments:[{}]}
...
execute if score @a[tag=wicked,limit=1,scores={select=1}] magie matches 0..9 run item replace entity @a[tag=l30,tag=wicked,limit=1,scores={select=1,magie=0..9}] hotbar.3 with red_dye{HideFlags:3,CustomModelData:10140001,Unbreakable:1,display:{Name:"{\"text\":\"§cReloading\"}"},Enchantments:[{}]}
...
execute if score @a[tag=wicked,limit=1,scores={select=1}] magie matches 0..4 run item replace entity @a[tag=l10,tag=wicked,limit=1,scores={select=1,magie=0..4}] hotbar.1 with red_dye{HideFlags:3,CustomModelData:10140001,Unbreakable:1,display:{Name:"{\"text\":\"§cReloading\"}"},Enchantments:[{}]}
...
execute as @p if predicate wicked:magie_score run say a