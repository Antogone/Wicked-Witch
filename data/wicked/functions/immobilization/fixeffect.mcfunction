...
effect give @e[distance=..1,team=fix] mining_fatigue 2 255 true
effect give @e[distance=..1,team=fix] nausea 2 255 true
effect give @e[distance=..1,team=fix] weakness 2 255 true
effect give @e[distance=..1,team=fix] slowness 2 255 true
effect give @e[distance=..1,team=fix] jump_boost 2 190 true
effect give @e[distance=..1,team=fix] darkness 2 255 true
effect give @e[distance=..1,team=fix] glowing 2 255 true
