...
execute as @e[tag=telp,limit=1,sort=nearest] at @s run teleport @a[tag=wicked,predicate=wicked:is_sneaking] @s
execute as @e[tag=wicked] at @s anchored feet run teleport @a[tag=wicked,predicate=wicked:is_sneaking] ^ ^ ^-0.6
