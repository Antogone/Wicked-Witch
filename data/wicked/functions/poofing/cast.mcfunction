...
execute at @s if entity @e[tag=telp] run execute if entity @p[tag=wicked,tag=dark_purple] run execute as @e[tag=wicked,limit=1] at @s run particle minecraft:dust 0.565 0.184 1 1 ^ ^ ^ 0.3 1 0.3 0.001 500 force
execute at @s if entity @e[tag=telp] run execute if entity @p[tag=wicked,tag=dark_purple] run execute as @e[tag=wicked,limit=1] at @s run particle minecraft:dust 0.565 0.184 1 1 ^ ^ ^ 0.3 1 0.3 0.001 500 force
