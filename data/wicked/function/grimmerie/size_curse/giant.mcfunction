...
execute at @s run execute as @e[type=!#dontharm,sort=nearest,distance=..3,tag=!wicked] run attribute @s scale base set 10
execute at @s run execute as @e[type=!#dontharm,sort=nearest,distance=..3,tag=!wicked] run attribute @s step_height base set 5
