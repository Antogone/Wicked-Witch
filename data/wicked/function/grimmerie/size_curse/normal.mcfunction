...
execute at @s run execute as @e[type=!#dontharm,sort=nearest,distance=..10,tag=!wicked] run attribute @s scale base set 1
execute at @s run execute as @e[type=!#dontharm,sort=nearest,distance=..10,tag=!wicked] run attribute @s step_height base set 0.5
